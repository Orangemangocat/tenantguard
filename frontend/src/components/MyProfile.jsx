...
const MyProfile = ({ onClose }) => {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      const response = await fetch('https://www.tenantguard.net/auth/me', {
        method: 'GET',
        headers: {
  ...
  const refreshAccessToken = async () => {
    try {
      ...
      const response = await fetch('https://www.tenantguard.net/auth/refresh', {
        method: 'POST',
        headers: {
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      const response = await fetch(`https://www.tenantguard.net/auth/users/${user.id}`, {
        method: 'PUT',
        headers: {
          'Authorization': `Bearer ${accessToken}`,
          'Content-Type': 'application/json'
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <p className="text-gray-900 py-2 break-all">{user.avatar_url || 'Not provided'}</p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                {editing ? (
                  ...
                  <p className="text-gray-900 py-2 whitespace-pre-wrap">{user.bio || 'No bio provided'}</p>
                )}
              </div>
          ...
          {editing && (
            <div className="mt-8 flex gap-3 justify-end border-t pt-6">
              ...
              <button
                ...
                disabled={saving}
                className="px-6 py-2 bg-red-800 text-white rounded-lg hover:bg-red-900 transition-colors disabled:opacity-50 flex items-center gap-2"
              >
                {saving ? (
                  <>
