...
class BlogPostEnhanced(db.Model):
    ...
    submitted_by_user_id = db.Column(db.Integer, db.ForeignKey('auth_users.id'))
    approved_by_user_id = db.Column(db.Integer, db.ForeignKey('auth_users.id'))
    approved_at = db.Column(db.DateTime)
    rejected_by_user_id = db.Column(db.Integer, db.ForeignKey('auth_users.id'))
    ...
    # Relationships
    submitted_by = db.relationship('AuthUser', foreign_keys=[submitted_by_user_id], backref='submitted_posts')
    approved_by = db.relationship('AuthUser', foreign_keys=[approved_by_user_id], backref='approved_posts')
    rejected_by = db.relationship('AuthUser', foreign_keys=[rejected_by_user_id], backref='rejected_posts')
